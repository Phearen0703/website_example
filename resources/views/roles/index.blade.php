                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <form class="row g-2">
                                    ...
                                    <div class="col-auto">
                                        <a href="{{ route('role.create') }}" type="button" class="btn btn-primary"><i
                                    ...
                                    @if ($rows)
                                        ...
                                        @foreach ($rows as $row)
                                            <tr>
                                                <td>{{ $i++ }}</td>
                                                <td>{{ $row['name'] }}</td>
                                                <td><span class="badge bg-danger-subtle text-danger">Active</span></td>

                                                <td class="text-end">
                                                    <a href="{{ route('role.edit',['id'=>$row->id]) }}"><i class="las la-pen text-secondary fs-18"></i></a>
                                                    <a href="{{ route('role.delete',['id'=>$row->id]) }}"><i class="las la-trash-alt text-secondary fs-18"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
